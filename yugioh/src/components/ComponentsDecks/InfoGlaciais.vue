<template>
    <div class="size-80 bg-white/70 border rounded-lg mt-20 ml-52">
        ...
        <img id="GlaciaisInf" src="@/assets/Decks de estrutura/CorrentesGlaciais.png" alt="GlaciasiInf" width="300"
            height="300" class="-translate-y-[25px] translate-x-[10px]" />

        <p class="text-white text-3xl -translate-y-[40px] translate-x-[100px]">R$74,99</p>
    ...
    <p class="absolute font-semibold text-black text-lg -translate-y-[310px] translate-x-[800px]">Deck Estrutural - Correntes Glaciais</p>
