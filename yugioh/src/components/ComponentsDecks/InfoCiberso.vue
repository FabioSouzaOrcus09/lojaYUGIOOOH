<template>
    <div class="size-80 bg-white/70 border rounded-lg mt-20 ml-52">
        ...
        <img id="CibersoInf" src="@/assets/Decks de estrutura/LinkCiberso.png" alt="CibersoInf" width="260"
            height="260" class="translate-y-[0px] translate-x-[26px]" />

        <p class="text-white text-3xl translate-y-[10px] translate-x-[100px]">R$39,99</p>
    ...
    <p class="absolute font-semibold text-black text-lg -translate-y-[310px] translate-x-[800px]">Deck Estrutural - Link Ciberso</p>
