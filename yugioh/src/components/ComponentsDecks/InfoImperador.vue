<template>
    <div class="size-80 bg-white/70 border rounded-lg mt-20 ml-52">
        ...
        <img id="ImperadorInf" src="@/assets/Decks de estrutura/ImperadordasTrevas.png" alt="ImperadorInf" width="260"
    ...
    <p class="absolute font-semibold text-black text-lg -translate-y-[310px] translate-x-[800px]">Deck Estrutural - Imperador das Trevas</p>
    ...
    <p class="absolute leading-tight text-black text-base -translate-y-[230px] translate-x-[800px]">
        ...
        <br>
        -41 Cartas<br>
        -01 Token Exclusiva<br>
        -01 Guia de Iniciantes<br>
        Tapete de Duelo de luxo<br>
    </p>
